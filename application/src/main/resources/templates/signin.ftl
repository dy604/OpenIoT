  ...
  <body>
    ...
    <div class="collapse navbar-collapse navbar-right " id="example-navbar-collapse" >
        <ul class="nav navbar-nav">
            ...
            <li><a href="${request.contextPath}/api/signupui"><span class="glyphicon glyphicon-log-in"></span> 注册</a></li>
   ...
   <div class = 'content'>
	<div class ='content-body'>
        <div class = 'header_first'><span class='header'>登录</span> <span class='header_content'>暂没有账号，立即<a href='${request.contextPath}/api/signupui'> 注册</a></span></div>
