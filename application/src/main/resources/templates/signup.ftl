  ...
  <nav class="navbar navbar-inverse bar" role="navigation">
    ...
    <div class="collapse navbar-collapse navbar-right " id="example-navbar-collapse" >
        <ul class="nav navbar-nav">
            ...
            <li><a href="${request.contextPath}/api/signinui"><span class="glyphicon glyphicon-log-in"></span> 登录</a></li>
	...
	<div class ='content-body'>
        <div class = 'header_first'><span class='header'>注册</span> <span class='header_content'>已有账号，立即<a href='${request.contextPath}/api/signinui'> 登录</a></span></div>
<form class="form-horizontal" role="form" action="#" >
    ...
    <div class="col-sm-offset-2 col-sm-10">
        <a href="${request.contextPath}/api/homepage" class="btn btn-default" style='padding: 10px 35px;'>注册</a>
    </div>
    </div>
</form>
	</div>
